...
class TestArDefaultResolver(unittest.TestCase):
    ...
    def test_CreateIdentifier(self):
        ...
        self.assertEqual("", resolver.CreateIdentifier("", Ar.ResolvedPath("some/relative/path.usd")))
        self.assertEqual("", resolver.CreateIdentifier("", Ar.ResolvedPath("/some/absolute/path.usd")))

        # Test for valid paths
        self.assertEqual("/some/absolute/path.usd", resolver.CreateIdentifier("/some/absolute/path.usd", Ar.ResolvedPath("some/relative/path.usd")))
        self.assertEqual("/some/absolute/path.usd", resolver.CreateIdentifier("/some/absolute/path.usd", Ar.ResolvedPath("/some/absolute/path.usd")))

        self.assertEqual("/some/absolute/some/relative/path.usd", resolver.CreateIdentifier("./some/relative/path.usd", Ar.ResolvedPath("/some/absolute/")))
        self.assertEqual("/some/absolute/some/relative/path.usd", resolver.CreateIdentifier("./some/relative/path.usd", Ar.ResolvedPath("/some/absolute/path.usd")))
        self.assertEqual("/some/some/relative/path.usd", resolver.CreateIdentifier("../some/relative/path.usd", Ar.ResolvedPath("/some/absolute/")))
        self.assertEqual("/some/some/relative/path.usd", resolver.CreateIdentifier("../some/relative/path.usd", Ar.ResolvedPath("/some/absolute/path.usd")))

        self.assertEqual("/other/relative/path.usd", resolver.CreateIdentifier("/some/../other/relative/path.usd", Ar.ResolvedPath("/some/absolute/path.usd")))
    ...
    def test_CreateIdentifierForNewAsset(self):
        ...
        self.assertEqual("", resolver.CreateIdentifierForNewAsset("", Ar.ResolvedPath("some/relative/path.usd")))
        self.assertEqual("", resolver.CreateIdentifierForNewAsset("", Ar.ResolvedPath("/some/absolute/path.usd")))

        # Test for valid paths
        self.assertEqual("/some/absolute/path.usd", resolver.CreateIdentifierForNewAsset("/some/absolute/path.usd", Ar.ResolvedPath("some/relative/path.usd")))
        self.assertEqual("/some/absolute/path.usd", resolver.CreateIdentifierForNewAsset("/some/absolute/path.usd", Ar.ResolvedPath("/some/absolute/path.usd")))

        self.assertEqual("/some/absolute/some/relative/path.usd", resolver.CreateIdentifierForNewAsset("./some/relative/path.usd", Ar.ResolvedPath("/some/absolute/")))
        self.assertEqual("/some/absolute/some/relative/path.usd", resolver.CreateIdentifierForNewAsset("./some/relative/path.usd", Ar.ResolvedPath("/some/absolute/path.usd")))
        self.assertEqual("/some/some/relative/path.usd", resolver.CreateIdentifierForNewAsset("../some/relative/path.usd", Ar.ResolvedPath("/some/absolute/")))
        self.assertEqual("/some/some/relative/path.usd", resolver.CreateIdentifierForNewAsset("../some/relative/path.usd", Ar.ResolvedPath("/some/absolute/path.usd")))

        self.assertEqual("/other/relative/path.usd", resolver.CreateIdentifierForNewAsset("/some/../other/relative/path.usd", Ar.ResolvedPath("/some/absolute/path.usd")))
        ...
        with tempfile.TemporaryDirectory() as temp_dir_path:
            ...
            with Ar.ResolverContextBinder(ctx):
                with Ar.ResolverScopedCache():
                    # Resolve
                    self.assertEqual(os.path.abspath(layer_file_path), resolver.Resolve(layer_identifier))
                    # Remove file
